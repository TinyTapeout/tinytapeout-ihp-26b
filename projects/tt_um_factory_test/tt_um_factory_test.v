module tt_um_factory_test (clk,
 ...
 sg13g2_inv_1 _039_ (.Y(_000_),
    .A(net38));
 sg13g2_inv_1 _040_ (.Y(_010_),
    .A(net1));
 sg13g2_inv_1 _041_ (.Y(_011_),
    .A(net3));
 sg13g2_inv_1 _042_ (.Y(_012_),
    .A(net4));
 sg13g2_inv_1 _043_ (.Y(_013_),
    .A(net5));
 sg13g2_inv_1 _044_ (.Y(_014_),
    .A(net6));
 sg13g2_inv_1 _045_ (.Y(_015_),
    .A(net7));
 sg13g2_inv_1 _046_ (.Y(_016_),
    .A(net8));
 sg13g2_inv_1 _047_ (.Y(_017_),
    .A(net9));
 sg13g2_xor2_1 _048_ (.B(\cnt[0] ),
    .A(net32),
    .X(_001_));
 sg13g2_and3_1 _049_ (.X(_018_),
    .A(net32),
    .B(\cnt[0] ),
    .C(net29));
 sg13g2_a21oi_1 _050_ (.A1(\cnt[1] ),
    .A2(\cnt[0] ),
    .Y(_019_),
    .B1(net29));
 sg13g2_nor2_1 _051_ (.A(_018_),
    .B(net30),
    .Y(_002_));
 sg13g2_xor2_1 _052_ (.B(_018_),
    .A(net34),
    .X(_003_));
 sg13g2_and2_1 _053_ (.A(net34),
    .B(net26),
    .X(_020_));
 sg13g2_a21oi_1 _054_ (.A1(\cnt[3] ),
    .A2(_018_),
    .Y(_021_),
    .B1(net26));
 sg13g2_a21oi_1 _055_ (.A1(_018_),
    .A2(_020_),
    .Y(_004_),
    .B1(net27));
 sg13g2_and3_1 _056_ (.X(_022_),
    .A(net36),
    .B(_018_),
    .C(_020_));
 sg13g2_a21oi_1 _057_ (.A1(_018_),
    .A2(_020_),
    .Y(_023_),
    .B1(net36));
 sg13g2_nor2_1 _058_ (.A(_022_),
    .B(net37),
    .Y(_005_));
 sg13g2_nand4_1 _059_ (.B(\cnt[6] ),
    .C(_018_),
    .A(\cnt[5] ),
    .Y(_024_),
    .D(_020_));
 sg13g2_xor2_1 _060_ (.B(_022_),
    .A(net24),
    .X(_006_));
 sg13g2_xnor2_1 _061_ (.Y(_007_),
    .A(net22),
    .B(_024_));
 sg13g2_and2_1 _062_ (.A(net20),
    .B(net1),
    .X(uio_oe[7]));
 sg13g2_a21oi_1 _063_ (.A1(net1),
    .A2(net10),
    .Y(_025_),
    .B1(net20));
 sg13g2_a21oi_1 _064_ (.A1(_000_),
    .A2(uio_oe[7]),
    .Y(uo_out[0]),
    .B1(_025_));
 sg13g2_nand2b_1 _065_ (.Y(_026_),
    .B(net11),
    .A_N(net20));
 sg13g2_and2_1 _066_ (.A(\cnt[1] ),
    .B(net21),
    .X(uio_out[1]));
 sg13g2_nor2_1 _067_ (.A(net19),
    .B(uio_out[1]),
    .Y(_027_));
 sg13g2_a22oi_1 _068_ (.Y(uo_out[1]),
    .B1(_026_),
    .B2(_027_),
    .A2(_011_),
    .A1(net19));
 sg13g2_nand2b_1 _069_ (.Y(_028_),
    .B(net12),
    .A_N(net20));
 sg13g2_and2_1 _070_ (.A(\cnt[2] ),
    .B(net21),
    .X(uio_out[2]));
 sg13g2_nor2_1 _071_ (.A(net19),
    .B(uio_out[2]),
    .Y(_029_));
 sg13g2_a22oi_1 _072_ (.Y(uo_out[2]),
    .B1(_028_),
    .B2(_029_),
    .A2(_012_),
    .A1(net19));
 sg13g2_nand2b_1 _073_ (.Y(_030_),
    .B(net13),
    .A_N(net20));
 sg13g2_and2_1 _074_ (.A(\cnt[3] ),
    .B(net21),
    .X(uio_out[3]));
 sg13g2_nor2_1 _075_ (.A(net19),
    .B(uio_out[3]),
    .Y(_031_));
 sg13g2_a22oi_1 _076_ (.Y(uo_out[3]),
    .B1(_030_),
    .B2(_031_),
    .A2(_013_),
    .A1(net19));
 sg13g2_nand2b_1 _077_ (.Y(_032_),
    .B(net14),
    .A_N(net2));
 sg13g2_and2_1 _078_ (.A(\cnt[4] ),
    .B(net21),
    .X(uio_out[4]));
 sg13g2_nor2_1 _079_ (.A(net18),
    .B(uio_out[4]),
    .Y(_033_));
 sg13g2_a22oi_1 _080_ (.Y(uo_out[4]),
    .B1(_032_),
    .B2(_033_),
    .A2(_014_),
    .A1(net18));
 sg13g2_nand2b_1 _081_ (.Y(_034_),
    .B(net15),
    .A_N(net20));
 sg13g2_and2_1 _082_ (.A(\cnt[5] ),
    .B(net21),
    .X(uio_out[5]));
 sg13g2_nor2_1 _083_ (.A(net18),
    .B(uio_out[5]),
    .Y(_035_));
 sg13g2_a22oi_1 _084_ (.Y(uo_out[5]),
    .B1(_034_),
    .B2(_035_),
    .A2(_015_),
    .A1(net18));
 sg13g2_nand2b_1 _085_ (.Y(_036_),
    .B(net16),
    .A_N(net20));
 sg13g2_and2_1 _086_ (.A(\cnt[6] ),
    .B(net21),
    .X(uio_out[6]));
 sg13g2_nor2_1 _087_ (.A(net18),
    .B(uio_out[6]),
    .Y(_037_));
 sg13g2_a22oi_1 _088_ (.Y(uo_out[6]),
    .B1(_036_),
    .B2(_037_),
    .A2(_016_),
    .A1(net18));
 sg13g2_nand2b_1 _089_ (.Y(_008_),
    .B(net17),
    .A_N(net20));
 sg13g2_and2_1 _090_ (.A(\cnt[7] ),
    .B(net21),
    .X(uio_out[7]));
 sg13g2_nor2_1 _091_ (.A(net18),
    .B(uio_out[7]),
    .Y(_009_));
 sg13g2_a22oi_1 _092_ (.Y(uo_out[7]),
    .B1(_008_),
    .B2(_009_),
    .A2(_017_),
    .A1(net18));
 sg13g2_and2_1 _093_ (.A(\cnt[0] ),
    .B(net21),
    .X(uio_out[0]));
 sg13g2_dfrbpq_1 _094_ (.RESET_B(net39),
    .D(_000_),
    .Q(\cnt[0] ),
    .CLK(clknet_1_1__leaf_clk));
 sg13g2_dfrbpq_1 _095_ (.RESET_B(net39),
    .D(net33),
    .Q(\cnt[1] ),
    .CLK(clknet_1_1__leaf_clk));
 sg13g2_dfrbpq_1 _096_ (.RESET_B(net39),
    .D(net31),
    .Q(\cnt[2] ),
    .CLK(clknet_1_1__leaf_clk));
 sg13g2_dfrbpq_1 _097_ (.RESET_B(net39),
    .D(net35),
    .Q(\cnt[3] ),
    .CLK(clknet_1_0__leaf_clk));
 sg13g2_dfrbpq_1 _098_ (.RESET_B(net39),
    .D(net28),
    .Q(\cnt[4] ),
    .CLK(clknet_1_0__leaf_clk));
 sg13g2_dfrbpq_1 _099_ (.RESET_B(net39),
    .D(_005_),
    .Q(\cnt[5] ),
    .CLK(clknet_1_0__leaf_clk));
 sg13g2_dfrbpq_1 _100_ (.RESET_B(net39),
    .D(net25),
    .Q(\cnt[6] ),
    .CLK(clknet_1_0__leaf_clk));
 sg13g2_dfrbpq_1 _101_ (.RESET_B(net39),
    .D(net23),
    .Q(\cnt[7] ),
    .CLK(clknet_1_0__leaf_clk));
 sg13g2_dfrbpq_1 _102_ (.RESET_B(net1),
    .D(net),
    .Q(rst_n_i),
    .CLK(clknet_1_1__leaf_clk));
 sg13g2_tiehi _102__22 (.L_HI(net));
 ...
 sg13g2_buf_1 fanout18 (.A(_010_),
    .X(net18));
 sg13g2_buf_1 fanout19 (.A(_010_),
    .X(net19));
 sg13g2_buf_1 fanout20 (.A(net2),
    .X(net20));
 sg13g2_buf_1 fanout21 (.A(net2),
    .X(net21));
 sg13g2_dlygate4sd3_1 hold23 (.A(\cnt[7] ),
    .X(net22));
 sg13g2_dlygate4sd3_1 hold24 (.A(_007_),
    .X(net23));
 sg13g2_dlygate4sd3_1 hold25 (.A(\cnt[6] ),
    .X(net24));
 sg13g2_dlygate4sd3_1 hold26 (.A(_006_),
    .X(net25));
 sg13g2_dlygate4sd3_1 hold27 (.A(\cnt[4] ),
    .X(net26));
 sg13g2_dlygate4sd3_1 hold28 (.A(_021_),
    .X(net27));
 sg13g2_dlygate4sd3_1 hold29 (.A(_004_),
    .X(net28));
 sg13g2_dlygate4sd3_1 hold30 (.A(\cnt[2] ),
    .X(net29));
 sg13g2_dlygate4sd3_1 hold31 (.A(_019_),
    .X(net30));
 sg13g2_dlygate4sd3_1 hold32 (.A(_002_),
    .X(net31));
 sg13g2_dlygate4sd3_1 hold33 (.A(\cnt[1] ),
    .X(net32));
 sg13g2_dlygate4sd3_1 hold34 (.A(_001_),
    .X(net33));
 sg13g2_dlygate4sd3_1 hold35 (.A(\cnt[3] ),
    .X(net34));
 sg13g2_dlygate4sd3_1 hold36 (.A(_003_),
    .X(net35));
 sg13g2_dlygate4sd3_1 hold37 (.A(\cnt[5] ),
    .X(net36));
 sg13g2_dlygate4sd3_1 hold38 (.A(_023_),
    .X(net37));
 sg13g2_dlygate4sd3_1 hold39 (.A(\cnt[0] ),
    .X(net38));
 sg13g2_dlygate4sd3_1 hold40 (.A(rst_n_i),
    .X(net39));
