module tt_um_jmarin_test1 (clk,
 ...
 sg13g2_and2_1 _061_ (.A(net48),
    .B(net47),
    .X(_008_));
 sg13g2_and2_1 _062_ (.A(net45),
    .B(net44),
    .X(_009_));
 sg13g2_xor2_1 _063_ (.B(net44),
    .A(net45),
    .X(_010_));
 sg13g2_xor2_1 _064_ (.B(_010_),
    .A(_008_),
    .X(_001_));
 sg13g2_a21oi_2 _065_ (.B1(_009_),
    .Y(_011_),
    .A2(_010_),
    .A1(_008_));
 sg13g2_and2_1 _066_ (.A(net50),
    .B(net43),
    .X(_012_));
 sg13g2_xnor2_1 _067_ (.Y(_013_),
    .A(net50),
    .B(net43));
 sg13g2_nor2_1 _068_ (.A(_011_),
    .B(_013_),
    .Y(_014_));
 sg13g2_xor2_1 _069_ (.B(_013_),
    .A(_011_),
    .X(_002_));
 sg13g2_or2_1 _070_ (.X(_015_),
    .B(net53),
    .A(net57));
 sg13g2_and2_1 _071_ (.A(net54),
    .B(net53),
    .X(_016_));
 sg13g2_xor2_1 _072_ (.B(net53),
    .A(net54),
    .X(_017_));
 sg13g2_nor2_1 _073_ (.A(_012_),
    .B(_014_),
    .Y(_018_));
 sg13g2_xnor2_1 _074_ (.Y(_003_),
    .A(_017_),
    .B(_018_));
 sg13g2_nand2b_1 _075_ (.Y(_019_),
    .B(_017_),
    .A_N(_013_));
 sg13g2_a21oi_1 _076_ (.A1(_012_),
    .A2(_015_),
    .Y(_020_),
    .B1(_016_));
 sg13g2_o21ai_1 _077_ (.B1(_020_),
    .Y(_021_),
    .A1(_011_),
    .A2(_019_));
 sg13g2_nand2_1 _078_ (.Y(_022_),
    .A(net49),
    .B(net46));
 sg13g2_xor2_1 _079_ (.B(net46),
    .A(net49),
    .X(_023_));
 sg13g2_inv_1 _080_ (.Y(_024_),
    .A(_023_));
 sg13g2_nand2_1 _081_ (.Y(_025_),
    .A(_021_),
    .B(_023_));
 sg13g2_xnor2_1 _082_ (.Y(_004_),
    .A(_021_),
    .B(_024_));
 sg13g2_nor2_1 _083_ (.A(net56),
    .B(net52),
    .Y(_026_));
 sg13g2_xnor2_1 _084_ (.Y(_027_),
    .A(net56),
    .B(net52));
 sg13g2_nand2_1 _085_ (.Y(_028_),
    .A(_022_),
    .B(_025_));
 sg13g2_xnor2_1 _086_ (.Y(_005_),
    .A(_027_),
    .B(_028_));
 sg13g2_nor2_1 _087_ (.A(_024_),
    .B(_027_),
    .Y(_029_));
 sg13g2_nor2_1 _088_ (.A(_022_),
    .B(_026_),
    .Y(_030_));
 sg13g2_a221oi_1 _089_ (.B2(_029_),
    .C1(_030_),
    .B1(_021_),
    .A1(net56),
    .Y(_031_),
 ...
 sg13g2_nand2_1 _090_ (.Y(_032_),
    .A(net55),
    .B(net51));
 sg13g2_nor2_1 _091_ (.A(net55),
    .B(net51),
    .Y(_033_));
 sg13g2_xor2_1 _092_ (.B(net51),
    .A(net55),
    .X(_034_));
 sg13g2_xnor2_1 _093_ (.Y(_006_),
    .A(_031_),
    .B(_034_));
 sg13g2_o21ai_1 _094_ (.B1(_032_),
    .Y(_035_),
    .A1(_031_),
    .A2(_033_));
 sg13g2_xnor2_1 _095_ (.Y(_036_),
    .A(net42),
    .B(net41));
 sg13g2_xnor2_1 _096_ (.Y(_007_),
    .A(_035_),
    .B(_036_));
 sg13g2_xor2_1 _097_ (.B(net47),
    .A(net48),
    .X(_000_));
 sg13g2_dfrbpq_1 _098_ (.RESET_B(net19),
    .D(_000_),
    .Q(\b[0] ),
    .CLK(clknet_2_3__leaf_clk));
 sg13g2_dfrbpq_1 _099_ (.RESET_B(net20),
    .D(_001_),
    .Q(\b[1] ),
    .CLK(clknet_2_3__leaf_clk));
 sg13g2_dfrbpq_1 _100_ (.RESET_B(net21),
    .D(_002_),
    .Q(\b[2] ),
    .CLK(clknet_2_2__leaf_clk));
 sg13g2_dfrbpq_1 _101_ (.RESET_B(net22),
    .D(_003_),
    .Q(\b[3] ),
    .CLK(clknet_2_2__leaf_clk));
 sg13g2_dfrbpq_1 _102_ (.RESET_B(net23),
    .D(_004_),
    .Q(\b[4] ),
    .CLK(clknet_2_0__leaf_clk));
 sg13g2_dfrbpq_1 _103_ (.RESET_B(net24),
    .D(_005_),
    .Q(\b[5] ),
    .CLK(clknet_2_0__leaf_clk));
 sg13g2_dfrbpq_1 _104_ (.RESET_B(net25),
    .D(_006_),
    .Q(\b[6] ),
    .CLK(clknet_2_1__leaf_clk));
 sg13g2_dfrbpq_1 _105_ (.RESET_B(net26),
    .D(_007_),
    .Q(\b[7] ),
    .CLK(clknet_2_1__leaf_clk));
 sg13g2_dfrbpq_1 _106_ (.RESET_B(net27),
    .D(net48),
    .Q(uo_out[0]),
    .CLK(clknet_2_3__leaf_clk));
 sg13g2_dfrbpq_1 _107_ (.RESET_B(net28),
    .D(net45),
    .Q(uo_out[1]),
    .CLK(clknet_2_3__leaf_clk));
 sg13g2_dfrbpq_1 _108_ (.RESET_B(net29),
    .D(net50),
    .Q(uo_out[2]),
    .CLK(clknet_2_2__leaf_clk));
 sg13g2_dfrbpq_1 _109_ (.RESET_B(net30),
    .D(net54),
    .Q(uo_out[3]),
    .CLK(clknet_2_2__leaf_clk));
 sg13g2_dfrbpq_1 _110_ (.RESET_B(net31),
    .D(net49),
    .Q(uo_out[4]),
    .CLK(clknet_2_0__leaf_clk));
 sg13g2_dfrbpq_1 _111_ (.RESET_B(net32),
    ...
    .Q(uo_out[5]),
    .CLK(clknet_2_0__leaf_clk));
 sg13g2_dfrbpq_1 _112_ (.RESET_B(net33),
    .D(net55),
    .Q(uo_out[6]),
    .CLK(clknet_2_1__leaf_clk));
 sg13g2_dfrbpq_1 _113_ (.RESET_B(net34),
    .D(net42),
    .Q(uo_out[7]),
    .CLK(clknet_2_1__leaf_clk));
 sg13g2_dfrbpq_1 _114_ (.RESET_B(net35),
    .D(net47),
    .Q(\a[0] ),
    .CLK(clknet_2_3__leaf_clk));
 sg13g2_dfrbpq_1 _115_ (.RESET_B(net36),
    .D(net44),
    .Q(\a[1] ),
    .CLK(clknet_2_3__leaf_clk));
 sg13g2_dfrbpq_1 _116_ (.RESET_B(net37),
    .D(net43),
    .Q(\a[2] ),
    .CLK(clknet_2_2__leaf_clk));
 sg13g2_dfrbpq_1 _117_ (.RESET_B(net38),
    .D(net53),
    .Q(\a[3] ),
    .CLK(clknet_2_2__leaf_clk));
 sg13g2_dfrbpq_1 _118_ (.RESET_B(net39),
    .D(net46),
    .Q(\a[4] ),
    .CLK(clknet_2_0__leaf_clk));
 sg13g2_dfrbpq_1 _119_ (.RESET_B(net40),
    .D(net52),
    .Q(\a[5] ),
    .CLK(clknet_2_0__leaf_clk));
 sg13g2_dfrbpq_1 _120_ (.RESET_B(net17),
    .D(net51),
    .Q(\a[6] ),
    .CLK(clknet_2_1__leaf_clk));
 sg13g2_dfrbpq_1 _121_ (.RESET_B(net18),
    .D(net41),
    .Q(\a[7] ),
    .CLK(clknet_2_1__leaf_clk));
 sg13g2_tiehi _121__18 (.L_HI(net18));
 sg13g2_tiehi _098__19 (.L_HI(net19));
 sg13g2_tiehi _099__20 (.L_HI(net20));
 sg13g2_tiehi _100__21 (.L_HI(net21));
 sg13g2_tiehi _101__22 (.L_HI(net22));
 sg13g2_tiehi _102__23 (.L_HI(net23));
 sg13g2_tiehi _103__24 (.L_HI(net24));
 sg13g2_tiehi _104__25 (.L_HI(net25));
 sg13g2_tiehi _105__26 (.L_HI(net26));
 sg13g2_tiehi _106__27 (.L_HI(net27));
 sg13g2_tiehi _107__28 (.L_HI(net28));
 sg13g2_tiehi _108__29 (.L_HI(net29));
 sg13g2_tiehi _109__30 (.L_HI(net30));
 sg13g2_tiehi _110__31 (.L_HI(net31));
 sg13g2_tiehi _111__32 (.L_HI(net32));
 sg13g2_tiehi _112__33 (.L_HI(net33));
 sg13g2_tiehi _113__34 (.L_HI(net34));
 sg13g2_tiehi _114__35 (.L_HI(net35));
 sg13g2_tiehi _115__36 (.L_HI(net36));
 sg13g2_tiehi _116__37 (.L_HI(net37));
 sg13g2_tiehi _117__38 (.L_HI(net38));
 sg13g2_tiehi _118__39 (.L_HI(net39));
 sg13g2_tiehi _119__40 (.L_HI(net40));
 sg13g2_buf_8 clkbuf_0_clk (.A(clk),
    .X(clknet_0_clk));
 sg13g2_tielo tt_um_jmarin_test1_2 (.L_LO(net2));
 sg13g2_tielo tt_um_jmarin_test1_3 (.L_LO(net3));
 sg13g2_tielo tt_um_jmarin_test1_4 (.L_LO(net4));
 sg13g2_tielo tt_um_jmarin_test1_5 (.L_LO(net5));
 sg13g2_tielo tt_um_jmarin_test1_6 (.L_LO(net6));
 sg13g2_tielo tt_um_jmarin_test1_7 (.L_LO(net7));
 sg13g2_tielo tt_um_jmarin_test1_8 (.L_LO(net8));
 sg13g2_tielo tt_um_jmarin_test1_9 (.L_LO(net9));
 sg13g2_tielo tt_um_jmarin_test1_10 (.L_LO(net10));
 sg13g2_tielo tt_um_jmarin_test1_11 (.L_LO(net11));
 sg13g2_tielo tt_um_jmarin_test1_12 (.L_LO(net12));
 sg13g2_tielo tt_um_jmarin_test1_13 (.L_LO(net13));
 sg13g2_tielo tt_um_jmarin_test1_14 (.L_LO(net14));
 sg13g2_tielo tt_um_jmarin_test1_15 (.L_LO(net15));
 sg13g2_tielo tt_um_jmarin_test1_16 (.L_LO(net16));
 sg13g2_tiehi _120__17 (.L_HI(net17));
 sg13g2_tielo tt_um_jmarin_test1_1 (.L_LO(net1));
 ...
 sg13g2_dlygate4sd3_1 hold1 (.A(\b[7] ),
    .X(net41));
 sg13g2_dlygate4sd3_1 hold2 (.A(\a[7] ),
    .X(net42));
 sg13g2_dlygate4sd3_1 hold3 (.A(\b[2] ),
    .X(net43));
 sg13g2_dlygate4sd3_1 hold4 (.A(\b[1] ),
    .X(net44));
 sg13g2_dlygate4sd3_1 hold5 (.A(\a[1] ),
    .X(net45));
 sg13g2_dlygate4sd3_1 hold6 (.A(\b[4] ),
    .X(net46));
 sg13g2_dlygate4sd3_1 hold7 (.A(\b[0] ),
    .X(net47));
 sg13g2_dlygate4sd3_1 hold8 (.A(\a[0] ),
    .X(net48));
 sg13g2_dlygate4sd3_1 hold9 (.A(\a[4] ),
    .X(net49));
 sg13g2_dlygate4sd3_1 hold10 (.A(\a[2] ),
    .X(net50));
 sg13g2_dlygate4sd3_1 hold11 (.A(\b[6] ),
    .X(net51));
 sg13g2_dlygate4sd3_1 hold12 (.A(\b[5] ),
    .X(net52));
 sg13g2_dlygate4sd3_1 hold13 (.A(\b[3] ),
    .X(net53));
 sg13g2_dlygate4sd3_1 hold14 (.A(\a[3] ),
    .X(net54));
 sg13g2_dlygate4sd3_1 hold15 (.A(\a[6] ),
    .X(net55));
 sg13g2_dlygate4sd3_1 hold16 (.A(\a[5] ),
    .X(net56));
 sg13g2_dlygate4sd3_1 hold17 (.A(\a[3] ),
    .X(net57));
